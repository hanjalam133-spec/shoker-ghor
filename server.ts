...
`;
  ...
  const DEFAULT_LANDING_PAGES = [
    ...
    },
    {
      ...
      headline: 'প্রিমিয়াম সিকুয়েন্স এম্বোটারি প্রোডাক্ট',
      subheadline: 'ইন্ডিয়ান কাতান কাপড়ের প্রিমিয়াম স্নাব বাটন প্রোডাক্ট। রাজকীয় আভিজাত্য ও আধুনিক ফ্যাশনের অনন্য মেলবন্ধন!',
